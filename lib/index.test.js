...
describe('react-jss', function () {
  ...
  describe('with JssSheetsRegistry', function () {
    it('should add style sheets to the registry from context', function () {
      var AppContainer = function (_React$Component2) {
        ...
        _createClass(AppContainer, [{
          key: 'render',
          value: function render() {
            var sheets = new _jss.SheetsRegistry();

            return _react2['default'].createElement(
              JssSheetsRegistry,
              { registry: sheets },
              _react2['default'].createElement(WrappedComponentA, _extends({}, this.props, {
                key: Math.random() // Require children to unmount on every render
              }))
            );

            (0, _expect2['default'])(sheets.registry.length).to.equal(2);
          }
        }]);
